...
const rooms = [
  {
    ...
    tag: 'Most Popular',
    tagColor: '#c9a84c',
    shortDesc: 'Experience luxurious 4-bedroom beachfront living with elegant interiors, panoramic sea views, and premium comfort.',
    capacity: '12',
    size: '1000 sq ft',
    amenities: ['Luxury 4 Bedrooms', 'Ocean View', 'King or Twin Beds', 'Private Balcony', 'Air Conditioning', 'Smart TV', 'Free Breakfast', 'Complimentary WiFi'],
    image: '/room1.jpg',
  },
  {
    ...
    tag: 'Garden View',
    tagColor: '#4a9fd4',
    shortDesc: 'Experience luxurious 2-bedroom beachfront living with elegant interiors, premium comfort, and relaxing surroundings.',
    capacity: '6',
    size: '500 sq ft',
    amenities: ['Luxury 2 Bedrooms', 'Garden View', 'King or Twin Beds', 'Air Conditioning', 'Smart TV', 'Free Breakfast', 'Complimentary WiFi', '24/7 Room Service'],
    image: '/room2.jpg',
  },
  {
    ...
    tag: 'Entire Property',
    tagColor: '#5da86c',
    shortDesc: 'Experience luxurious 6-bedroom beachfront living with spacious interiors, panoramic views, and premium hospitality.',
    capacity: '18',
    size: '1500 sq ft',
    amenities: ['Luxury 6 Bedrooms', 'Ocean View', 'King or Twin Beds', 'Private Balcony', 'Air Conditioning', 'Smart TV', 'Free Breakfast', 'Complimentary WiFi'],
    image: '/room3.jpg',
  },
  {
    ...
    tag: 'Best Value',
    tagColor: '#c97d4c',
    shortDesc: 'Experience luxurious beachfront comfort with elegant interiors and personalized hospitality.',
    capacity: '3',
    size: '150 sq ft',
    amenities: ['Luxury 1 Bedroom', 'King or Twin Beds', 'Private Balcony', 'Air Conditioning', 'Smart TV', 'Free Breakfast', 'Complimentary WiFi', '24/7 Room Service'],
    image: '/room4.jpg',
  },
]
